...
object KafkaOffset {
  ...
  /**
    ...
    */
  def getZkOffsetDir(groupId:String,topic:String):String = {
  ...
  /**
    ...
    * @return
    */
  def hasChildrenPath(zkClient:ZkClient,groupId:String,topic:String) : Boolean = {
    val path = getZkOffsetDir(groupId,topic)
  ...
  /**
    ...
    */
  def getOffSet(zkClient:ZkClient, zkClientUTF8:ZkClient, brokers:String, groupId:String, topic:String) : Map[TopicAndPartition, Long] = {
    ...
    //get offset dir
    val offsetDir = getZkOffsetDir(groupId,topic)
